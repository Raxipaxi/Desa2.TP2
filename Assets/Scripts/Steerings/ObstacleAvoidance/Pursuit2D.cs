...
public class Pursuit2D : ISteering2D
{
    private Transform _self;
    private Transform _target;
    private IVel _vel;
    private float _timePrediction;
    public Pursuit2D(Transform self, Transform target, IVel vel, float timePrediction)
    {
        _self = self;
        _target = target;
        _vel = vel;
    ...
    public Vector2 GetDir()
    {
        ...
        Vector2 dir = (finitPos - _self.position).normalized;
        return dir;
    }
}
